...
const quotePar=document.querySelector('.quote-par')
const btnGen=document.querySelector('.btn-generator')
...
function getQuote() {
    ...
    if (source==='Anonymous') {
        author.textContent='Snow'
    }else{
    quotePar.textContent=quote
    author.textContent=source
    }
}
getQuote()
 const rot=360
btnGen.addEventListener('click',function (params) {
